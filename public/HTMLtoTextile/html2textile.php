...
$text);
        ...
        $oktags =
array('p','ol','ul','li','i','b','em','strong','span','a','h[1-6]',
...
<html>
	...
	<hr/>
        ...
        {
            echo '<p><b>This will convert simple HTML data into Textile.</b></p>';
            echo '<p><b>Enter HTML data here:</b><br/><br/>';
            if (isSet($_POST['html']))
            {
...
<?
if (!isSet($_REQUEST['source']))
    echo '<a href="' . $_SERVER['SCRIPT_NAME'] .  '?source=show">Source code</a>';
elseif ($_REQUEST['source'] == "show")
    echo '<a href="' . $_SERVER['SCRIPT_NAME'] . '">Hide source code</a>';
?>
        </small>
        </p>
